export const USER_CONFIG = {
  ...
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "93ca3e9122abe6eab08ee562c2690013",
   // 模板消息id
 ...
 //接收公众号消息的微信号，如有多个，需要在{}里用英文逗号间隔，列如{“wx1”，“wx2”}
  ...
  USERS: [
    {
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "aCmMubfCNGG9R-GyVX_2XTZ3sFgg2_eNqKCqbmr5Pjo",
      // 所在省份
      province:“湖南”,
      // 所在城市
      city: "常德",
  ...
  CALLBACK_TEMPLATE_ID: "aCmMubfCNGG9R-GyVX_2XTZ3sFgg2_eNqKCqbmr5Pjo",
